...
<div class="menu">
    ...
    <nav>
        <a href="/findTelephone" class="item">Telephone</a>
        <a href="/findTablet" class="item">Tablet</a>
        <a href="/findAccessories" class="item">Accessories</a>
        <a href="/findOther" class="item">Other</a>
